            ...
            <div class="modal-body">
                ...
                <form id="addClassForm">
                    ...
                    <div class="form-group">
                        <label for="lop_vn">Lớp VN:</label>
                        <input type="text" name="lop_vn" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="lop_latin">Lớp Latin:</label>
                        <input type="text" name="lop_latin" class="form-control" required>
                    </div>
                    <div class="form-group">
